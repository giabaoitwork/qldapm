...
function HomePage(){
  ...
  const handleImageClick = () => {
    ...
    // Thêm các hàm xử lý cho sự kiện click trên hình ảnh tại đây
  };
          ...
          <Container className="mt-5">
            ...
            <Row>
              <Col md={12} className="text-center">
                <Button style={{backgroundColor: '#00FFB0' , borderColor: 'white'}} variant="primary" size="lg" onClick={handleViewReviewClick}>
                  Xem Đánh Giá
                </Button>
              </Col>
            </Row>
